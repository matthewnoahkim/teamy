...
export function DiscordBanner() {
  ...
  return (
    <div className="bg-[#5865F2] text-white py-2 px-4 text-center text-sm relative">
      <Link 
      ...
      >
        ...
        <span className="font-medium">Join our Discord server for support and updates!</span>
      </Link>
      <button 

  ...
  try {
    ...
    for (const test of esTests) {
      try {
        ...
        console.log(`[Release Event Scores] Test ${test.id} (${before?.name}): before update scoresReleased =`, before?.scoresReleased)
        ...
        console.log(`[Release Event Scores] Test ${test.id} (${updated.name}): after update scoresReleased =`, updated.scoresReleased)
    ...
    for (const test of regularTests) {
      try {
        ...
        console.log(`[Release Event Scores] Regular test ${test.id} (${before?.name}): before update releaseScoresAt =`, before?.releaseScoresAt)
